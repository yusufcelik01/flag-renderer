...
//vec3 I = vec3(0.75, 0.75, 0.75);          // point light intensity
//vec3 Iamb = vec3(0.8, 0.8, 0.8); // ambient light intensity
vec3 Iamb = vec3(0.75, 0.75, 0.75); // ambient light intensity
...
vec3 lightPos = vec3(7, 5, -7.5);   // light position in world coordinates
